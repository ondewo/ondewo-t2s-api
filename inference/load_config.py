...
class Models:
    ...
    def __init__(self, config_file: str, logger: logging.Logger = None, tacotron: bool = True,
                 waveglow: bool = True):
        ...
        if tacotron:
            ...
            self.tacotron_preprocessor = None
            self.tacotron_embedding = None
            self.tacotron_encoder = None
            self.tacotron_decoder = None
            self.tacotron_postnet = None
