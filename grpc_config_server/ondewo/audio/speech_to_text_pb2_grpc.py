...
from grpc_config_server.ondewo.audio import speech_to_text_pb2 as ondewo_dot_audio_dot_speech__to__text__pb2


class Speech2TextConfigurationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListSupportedLanguages = channel.unary_unary(
            '/ondewo.audio.Speech2TextConfiguration/ListSupportedLanguages',
        ...
        self.ListModelSetupsForLanguage = channel.unary_unary(
            '/ondewo.audio.Speech2TextConfiguration/ListModelSetupsForLanguage',
        ...
        self.ListAllModelSetups = channel.unary_unary(
            '/ondewo.audio.Speech2TextConfiguration/ListAllModelSetups',
        ...
        self.GetActiveModelConfig = channel.unary_unary(
            '/ondewo.audio.Speech2TextConfiguration/GetActiveModelConfig',
        ...
        self.SetModelConfig = channel.unary_unary(
            '/ondewo.audio.Speech2TextConfiguration/SetModelConfig',
...
def add_Speech2TextConfigurationServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        'ondewo.audio.Speech2TextConfiguration', rpc_method_handlers)
...
class Speech2TextConfiguration(object):
    ...
    def ListSupportedLanguages(request,
                               ...
                               timeout=None,
                               metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ondewo.audio.Speech2TextConfiguration/ListSupportedLanguages',
    ...
    def ListModelSetupsForLanguage(request,
                                   ...
                                   timeout=None,
                                   metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ondewo.audio.Speech2TextConfiguration/ListModelSetupsForLanguage',
    ...
    def ListAllModelSetups(request,
                           ...
                           timeout=None,
                           metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ondewo.audio.Speech2TextConfiguration/ListAllModelSetups',
    ...
    def GetActiveModelConfig(request,
                             ...
                             timeout=None,
                             metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ondewo.audio.Speech2TextConfiguration/GetActiveModelConfig',
    ...
    def SetModelConfig(request,
                       ...
                       timeout=None,
                       metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ondewo.audio.Speech2TextConfiguration/SetModelConfig',
