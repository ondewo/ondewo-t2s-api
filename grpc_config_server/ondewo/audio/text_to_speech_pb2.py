...
_INFERENCE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='composite_interface', full_name='ondewo.nlu.Inference.composite_interface', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COMPOSITEINTERFACE = _descriptor.Descriptor(
  name='CompositeInterface',
  full_name='ondewo.nlu.CompositeInterface',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='text_2_mel', full_name='ondewo.nlu.CompositeInterface.text_2_mel', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mel_2_audio', full_name='ondewo.nlu.CompositeInterface.mel_2_audio', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INFERENCE.fields_by_name['composite_interface'].message_type = _COMPOSITEINTERFACE
_INFERENCE.fields_by_name['caching'].message_type = _CACHING
_COMPOSITEINTERFACE.fields_by_name['text_2_mel'].message_type = _TEXT2MEL
_COMPOSITEINTERFACE.fields_by_name['mel_2_audio'].message_type = _MEL2AUDIO
...
DESCRIPTOR.message_types_by_name['CompositeInterface'] = _COMPOSITEINTERFACE
...
CompositeInterface = _reflection.GeneratedProtocolMessageType('CompositeInterface', (_message.Message,), {
  'DESCRIPTOR' : _COMPOSITEINTERFACE,
  '__module__' : 'ondewo.audio.text_to_speech_pb2'
  # @@protoc_insertion_point(class_scope:ondewo.nlu.CompositeInterface)
  })
_sym_db.RegisterMessage(CompositeInterface)
