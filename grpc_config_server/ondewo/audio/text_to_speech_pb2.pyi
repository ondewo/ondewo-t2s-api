...
class Text2Mel(google___protobuf___message___Message):
    ...
    @property
    def tacotron2(self) -> type___Tacotron2: ...
    ...
    def __init__(self,
        *,
        type : typing___Optional[typing___Text] = None,
        tacotron2 : typing___Optional[type___Tacotron2] = None,
        glow_tts : typing___Optional[type___GlowTTS] = None,
        glow_tts_triton : typing___Optional[type___GlowTTSTriton] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"glow_tts",b"glow_tts",u"glow_tts_triton",b"glow_tts_triton",u"tacotron2",b"tacotron2"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"glow_tts",b"glow_tts",u"glow_tts_triton",b"glow_tts_triton",u"tacotron2",b"tacotron2",u"type",b"type"]) -> None: ...
...
class Mel2Audio(google___protobuf___message___Message):
    ...
    @property
    def waveglow(self) -> type___Waveglow: ...

    @property
    def waveglow_triton(self) -> type___WaveglowTriton: ...

    @property
    def mb_melgan_tf(self) -> type___MbMelganTf: ...
    ...
    def __init__(self,
        *,
        type : typing___Optional[typing___Text] = None,
        waveglow : typing___Optional[type___Waveglow] = None,
        waveglow_triton : typing___Optional[type___WaveglowTriton] = None,
        mb_melgan_tf : typing___Optional[type___MbMelganTf] = None,
...
class Waveglow(google___protobuf___message___Message):
    ...
    @property
    def denoiser(self) -> type___Denoiser: ...
    ...
    def __init__(self,
        *,
        ...
        denoiser : typing___Optional[type___Denoiser] = None,
        ) -> None: ...
