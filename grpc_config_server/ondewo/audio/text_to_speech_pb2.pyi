...
class SynthesizeRequest(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        pcm : typing___Optional[builtin___int] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"length_scale",b"length_scale",u"model_id",b"model_id",u"noise_scale",b"noise_scale",u"pcm",b"pcm",u"sample_rate",b"sample_rate",u"text",b"text"]) -> None: ...
...
class SynthesizeResponse(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"audio",b"audio"]) -> None: ...
