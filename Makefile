...
# 2 - Update RELEASE.md
#
# Fully automated build and deploy process for ondewo-t2s-api
...
spc: ## Checks if the Release Branch, Tag and Pypi version already exist
	...
	@if test "$(setuppy_version)" != "version='${ONDEWO_T2S_API_VERSION}',"; then echo "-- Test 3: Setup.py not updated!!" & exit 1; else echo "-- Test 3: Setup.py is fine";fi
