            ...
            stages{
                ...
                stage('Tests') {
                     ...
                     steps {
                        ...
                        sh(script: "docker build -t ${TESTS_IMAGE_NAME} --build-arg SSH_PRIVATE_KEY=\"\$(cat ${ssh_key_file})\" --build-arg PUSH_NAME_STREAM=${PUSH_NAME_STREAM} -f docker/Dockerfile.tests .", label: "build image")
