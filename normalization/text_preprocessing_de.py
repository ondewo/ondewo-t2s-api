...
class TextNormalizerDe(NormalizerInterface):
    ...
    char_mapping: Dict[str, str] = {'a': '{AH AH1}', 'b': '{B EH}', 'c': '{TZ EH1}', 'd': '{D EH}', 'e': '{EH EH1}',
                                    'f': '{EH EH F F}', 'g': '{G EH EH1}', 'h': '{HH AH AH1}', 'i': '{I IH}',
                                    'j': '{IH O1 O1 T}', 'k': '{K AH AH1}',
                                    'l': '{EH EH L L}', 'm': '{EH EH M M}', 'n': '{EH1 EH1 N N}', 'o': '{O1 O1}',
                                    'p': '{P EH1 EH1}', 'q': '{K UH UH}',
                                    'r': '{EH EH1 R}', 's': '{EH S}', 't': '{T EH EH}', 'u': '{UH UH UH}',
                                    'v': '{F F AH AW UH}', 'w': '{V EH EH1}',
