...
class TestProcessingSSML:
    ...
    @pytest.mark.parametrize('text, expected_result', [
        ('<say-as interpret-as="spell">ABCD</say-as>', '{AH1 AH1 AH1 AH1 AH1} .  {B EH EH EH EH1} .  {TZ EH EH EH EH '
                                                       'EH1} .  {D EH '
                                                       'EH EH EH1 EH1} .'),
        ('<say-as interpret-as="spell">A9B109CD</say-as>',
         '{AH1 AH1 AH1 AH1 AH1} . nouin.  {B EH EH EH EH1} . eins. null. nouin.  {TZ '
         'EH EH EH EH EH1} .  {D EH EH EH EH1 EH1} .'),
        ('<say-as interpret-as="spell">A9B-109-CD</say-as>',
         '{AH1 AH1 AH1 AH1 AH1} . nouin.  {B EH EH EH EH1} .  {SH T R IH X} . eins. '
         'null. nouin.  {SH T R IH X} .  {TZ EH EH EH EH EH1} .  {D EH EH EH EH1 EH1} '
         '.'),
        ('<say-as interpret-as="spell">9657</say-as>', 'nouin. sechss. fünff. sieben.'),
        ('<say-as interpret-as="spell">96AAA57</say-as>',
         'nouin. sechss.  {AH1 AH1 AH1 AH1 AH1} .  {AH1 AH1 AH1 AH1 AH1} .  {AH1 AH1 '
         'AH1 AH1 AH1} . fünff. sieben.'),
        ('<say-as interpret-as="spell-with-names">ABCD</say-as>',
         '{AH1 AH1 AH1 AH1 AH1} , wie  anna.   {B EH EH EH EH1} , wie  berta.   {TZ EH '
         'EH EH EH EH1} , wie  cäsar.   {D EH EH EH EH1 EH1} , wie  daniel.'),
        ('<say-as interpret-as="spell-with-names">A9B109CD</say-as>',
         '{AH1 AH1 AH1 AH1 AH1} , wie  anna.  nouin.  {B EH EH EH EH1} , wie  berta.  '
         'eins. null. nouin.  {TZ EH EH EH EH EH1} , wie  cäsar.   {D EH EH EH EH1 '
         'EH1} , wie  daniel.'),
        ('<say-as interpret-as="spell-with-names">A9B-109-CD</say-as>',
         '{AH1 AH1 AH1 AH1 AH1} , wie  anna.  nouin.  {B EH EH EH EH1} , wie  berta.   '
         '{SH T R IH X} . eins. null. nouin.  {SH T R IH X} .  {TZ EH EH EH EH EH1} , '
         'wie  cäsar.   {D EH EH EH EH1 EH1} , wie  daniel.'),
        ('<say-as interpret-as="spell-with-names">9657</say-as>', 'nouin. sechss. fünff. sieben.'),
        ('<say-as interpret-as="spell-with-names">96AAA57</say-as>', 'nouin. sechss.  {AH1 AH1 AH1 AH1 AH1} , wie  '
                                                                     'anna.   {AH1 AH1 AH1 AH1 AH1} , '
                                                                     'wie  anna.   {AH1 AH1 AH1 AH1 AH1} , wie  anna. '
                                                                     ' fünff. sieben.'),
    ])
    ...
    @pytest.mark.parametrize('text, expected_result', [
        ('<say-as interpret-as="spell-with-names">ABCD</say-as>',
         '{AH1 AH1 AH1 AH1 AH1} , wie  anton.   {B EH EH EH EH1} , wie  berta.   {TZ '
         'EH EH EH EH EH1} , wie  cäsar.   {D EH EH EH EH1 EH1} , wie  dora.'
         ),
        ('<say-as interpret-as="spell-with-names">A9B109CD</say-as>',
         '{AH1 AH1 AH1 AH1 AH1} , wie  anton.  nouin.  {B EH EH EH EH1} , wie  berta.  '
         'eins. null. nouin.  {TZ EH EH EH EH EH1} , wie  cäsar.   {D EH EH EH EH1 '
         'EH1} , wie  dora.'),
        ('<say-as interpret-as="spell-with-names">A9B-109-CD</say-as>',
         '{AH1 AH1 AH1 AH1 AH1} , wie  anton.  nouin.  {B EH EH EH EH1} , wie  '
         'berta.   {SH T R IH X} . eins. null. nouin.  {SH T R IH X} .  {TZ EH EH EH '
         'EH EH1} , wie  cäsar.   {D EH EH EH EH1 EH1} , wie  dora.'),
        ('<say-as interpret-as="spell-with-names">96AAA57</say-as>',
         'nouin. sechss.  {AH1 AH1 AH1 AH1 AH1} , wie  anton.   {AH1 AH1 AH1 AH1 AH1} '
         ', wie  anton.   {AH1 AH1 AH1 AH1 AH1} , wie  anton.  fünff. sieben.'),
    ])
