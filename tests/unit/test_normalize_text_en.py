...
class TestNormalization:
    ...
    @pytest.mark.parametrize('time_to_normalize, expected_result', [
        (time(15, 30), 'three thirty pee em'),
        (time(15, 35, 45), 'three thirty five forty five pee em'),
    ])
    ...
    @pytest.mark.parametrize('text, expected_result', [
        ...
        ('ggg 165789lkkkk', 'ggg one six five seven eight nine lkkkk'),  # its a code
        ('ggg165789lkkkk', 'ggg one six five seven eight nine lkkkk'),
        ('ggg 165789lkkkk', 'ggg one six five seven eight nine lkkkk'),
        ...
        ('What did you do on April 3rd 1989?',
         'What did you do on april third nineteen eighty nine ?'),
        ('12-01', 'twelve - zero one'),  # its a code
        ('12.', 'twelve .'),
        ...
        ('still need your date of birth. '
         'For example, say February 25 1989.',
         'still need your date of birth . For example , say february twenty fifth '
        ...
        ("my daughter's grandfather has to make appointments on 10-05-1936",
         "my daughter ' s grandfather has to make appointments on october fifth "
         'nineteen thirty six'),
        ...
        ('she was born on January 15th 1998',
         'she was born on january fifteenth nineteen ninety eight'),
        ("Your social security number is 1234 and you were born on 15. January 1998. Right?",
         'Your social security number is twelve thirty four and you were born on '
         'fifteen . january nineteen ninety eight . Right ?'),
        ("How are you???", 'How are you ? ? ?'),
        ('text 30:50:00 text', 'text thirty : fifty : zero zero text')
    ])
    ...
    @pytest.mark.parametrize('text, expected_result', [
        ...
        # Test Urls Normalization
        ('www.google.de', 'double u double u double u dot google dot dee e'),
        ('www.fundamt.gv.at', 'double u double u double u dot fundamt dot gee vee dot ei tee'),
